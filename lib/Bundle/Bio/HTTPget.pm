...
Bundle::Bio::Root::HTTPget - module for fallback HTTP get operations when 
LWP:: is unavailable

=head1 SYNOPSIS

 use Bundle::Bio::Root::HTTPget;
 my $web = Bundle::Bio::Root::HTTPget->new();
...
package Bundle::Bio::Root::HTTPget;
...
sub get {
    my $self;
    if($_[0] && (ref($_[0]) or $_[0] =~ /^Bundle::Bio::/)) {
	$self = shift;
    }
