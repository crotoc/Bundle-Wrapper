#-----------------------------------------------------------------
#
# BioPerl module Bundle::Bio::Root::Exception
#
...
Bundle::Bio::Root::Exception - Generic exception objects for Bioperl

=head1 SYNOPSIS

=head2 Throwing exceptions using L<Error.pm throw|Error::throw>:

    use Bundle::Bio::Root::Exception;
    use Error;
    ...
    $file = shift;
    open (IN, $file) ||
	    throw Bundle::Bio::Root::FileOpenException ( "Can't open file $file for reading", $!);

=head2 Throwing exceptions using L<Bioperl throw|Bundle::Bio::Root::Root/throw>:

     # Here we have an object that ISA Bundle::Bio::Root::Root, so it inherits throw().

     open (IN, $file) || 
                $object->throw(-class => 'Bundle::Bio::Root::FileOpenException',
...
=head2 Catching and handling exceptions using L<Error.pm try|Error/try>:
    ...
    catch Bundle::Bio::Root::FileOpenException with {
        my $err = shift;
...
=head2 Defining a new Exception type as a subclass of Bundle::Bio::Root::Exception:

    @Bundle::Bio::TestException::ISA = qw( Bundle::Bio::Root::Exception );

=head1 DESCRIPTION

=head2 Exceptions defined in L<Bundle::Bio::Root::Exception>
...
=item Bundle::Bio::Root::Exception()

=item Bundle::Bio::Root::NotImplemented()

=item Bundle::Bio::Root::IOException()

=item Bundle::Bio::Root::FileOpenException()

=item Bundle::Bio::Root::SystemException()

=item Bundle::Bio::Root::BadParameter()

=item Bundle::Bio::Root::OutOfRange()

=item Bundle::Bio::Root::NoSuchThing()
...
that is accessible to your code):
    ...
    @NoCanDoException::ISA = qw( Bundle::Bio::Root::Exception );

All of the exceptions defined in this module inherit from a common
base class exception, Bundle::Bio::Root::Exception. This allows a user to
write a handler for all Bioperl-derived exceptions as follows:

           use Bundle::Bio::Whatever;
           use Error qw(:try);

           try {
                # some code that depends on Bioperl
           }
           catch Bundle::Bio::Root::Exception with {
               my $err = shift;
               print "A Bioperl exception occurred:\n$err\n";
           };

So if you do create your own exceptions, just be sure they inherit
from Bundle::Bio::Root::Exception directly, or indirectly by inheriting from a
Bundle::Bio::Root::Exception subclass.

The exceptions in Bundle::Bio::Root::Exception are extensions of Graham Barr's
L<Error> module available from CPAN.  Despite this dependency, the
L<Bundle::Bio::Root::Exception> module does not explicitly C<require Error>.
This permits Bundle::Bio::Root::Exception to be loaded even when
...
is to use L<Bundle::Bio::Root::Root/throw> which can use Error.pm 
when it's available. See documentation in Bundle::Bio::Root::Root for details.
...
L<Bundle::Bio::Root::Root/throw> for information about throwing 
L<Bundle::Bio::Root::Exception>-based exceptions.
...
package Bundle::Bio::Root::Exception;
use Bundle::Bio::Root::Version;
...
=head2 L<Bundle::Bio::Root::Exception>

 Purpose : A generic base class for all BioPerl exceptions.
           By including a "catch Bundle::Bio::Root::Exception" block, you
           should be able to trap all BioPerl exceptions.
 Example : throw Bundle::Bio::Root::Exception("A generic exception", $!);

=cut

#---------------------------------------------------------
@Bundle::Bio::Root::Exception::ISA = qw( Error );
#---------------------------------------------------------

=head1 Methods defined by Bundle::Bio::Root::Exception
...
=head2 new
 ...
 Arguments: key-value style arguments same as for Error::new()
     ...
     It is OK to create Bundle::Bio::Root::Exception objects without
...
=head2 pretty_format()
 ...
 Purpose : Get a nicely formatted string containing information about the 
           ...
           Bundle::Bio::Root::Root::throw(), with the addition of the name of
...
# But this isn't a big issue since it's for a Bundle::Bio::Root::-based method 
...
=head2 stringify()
 ...
 Example : catch Bundle::Bio::Root::Exception with {
              my $error = shift;
              print "$error";
           }
...
=head1 Subclasses of Bundle::Bio::Root::Exception 

=head2 L<Bundle::Bio::Root::NotImplemented>

 Purpose : Indicates that a method has not been implemented.
 Example : throw Bundle::Bio::Root::NotImplemented( 
...
#---------------------------------------------------------
@Bundle::Bio::Root::NotImplemented::ISA = qw( Bundle::Bio::Root::Exception );
#---------------------------------------------------------

=head2 L<Bundle::Bio::Root::IOException>

 Purpose : Indicates that some input/output-related trouble has occurred.
 Example : throw Bundle::Bio::Root::IOException( 
...
#---------------------------------------------------------
@Bundle::Bio::Root::IOException::ISA = qw( Bundle::Bio::Root::Exception );
#---------------------------------------------------------


=head2 L<Bundle::Bio::Root::FileOpenException>

 Purpose : Indicates that a file could not be opened.
 Example : throw Bundle::Bio::Root::FileOpenException( 
               -text   => "Can't open file $file for reading.",
	       -value  => $! );
...
#---------------------------------------------------------
@Bundle::Bio::Root::FileOpenException::ISA = qw( Bundle::Bio::Root::IOException );
#---------------------------------------------------------


=head2 L<Bundle::Bio::Root::SystemException>

 Purpose : Indicates that a system call failed.
 Example : unlink($file) or throw Bundle::Bio::Root::SystemException( 
...
#---------------------------------------------------------
@Bundle::Bio::Root::SystemException::ISA = qw( Bundle::Bio::Root::Exception );
#---------------------------------------------------------


=head2 L<Bundle::Bio::Root::BadParameter>

 Purpose : Indicates that one or more parameters supplied to a method 
           are invalid, unspecified, or conflicting.
 Example : throw Bundle::Bio::Root::BadParameter( 
...
#---------------------------------------------------------
@Bundle::Bio::Root::BadParameter::ISA = qw( Bundle::Bio::Root::Exception );
#---------------------------------------------------------


=head2 L<Bundle::Bio::Root::OutOfRange>

 Purpose : Indicates that a specified (start,end) range or 
           an index to an array is outside the permitted range.
 Example : throw Bundle::Bio::Root::OutOfRange( 
...
#---------------------------------------------------------
@Bundle::Bio::Root::OutOfRange::ISA = qw( Bundle::Bio::Root::Exception );
#---------------------------------------------------------


=head2 L<Bundle::Bio::Root::NoSuchThing>

 Purpose : Indicates that a requested thing cannot be located 
           and therefore could possibly be bogus.
 Example : throw Bundle::Bio::Root::NoSuchThing( 
...
#---------------------------------------------------------
@Bundle::Bio::Root::NoSuchThing::ISA = qw( Bundle::Bio::Root::Exception );
#---------------------------------------------------------
