#
# BioPerl module for Bundle::Bio::Root::RootI
#
...
Bundle::Bio::Root::RootI - Abstract interface to root object code
...
L<Bundle::Bio::Exception::NotImplemented> exception will result.
...
throw a L<Bundle::Bio::Exception::NotImplemented>.
...
sub new {
  ...
  unless ( $ENV{'BIOPERLDEBUG'} ) {
      carp("Use of new in Bundle::Bio::Root::RootI is deprecated.  Please use Bundle::Bio::Root::Root instead");
  }
  eval "require Bundle::Bio::Root::Root";
  return Bundle::Bio::Root::Root->new(@args);
}
...
sub deprecated{
    ...
    return if ($warn_version && $Bundle::Bio::Root::Version::VERSION < $warn_version);
    ...
    if ($version) {
        ...
        if ($Bundle::Bio::Root::Version::VERSION >= $version) {
            $self->throw($msg)
        } 
    }
...
=head2 _rearrange
 ...
 Source    : This function was taken from CGI.pm, written by Dr. Lincoln
           : Stein, and adapted for use in Bundle::Bio::Seq by Richard Resnick and
           : then adapted for use in Bundle::Bio::Root::Object.pm by Steve Chervitz,
           : then migrated into Bundle::Bio::Root::RootI.pm by Ewan Birney.
 Comments  :
...
=head2 _set_from_args
 ...
 Comments  :
           ...
           : Bundle::Bio::Tools::Run::WrapperBase's _setparams() method and code along
           : the lines of:
...
sub _cleanup_methods {
  ...
  unless ( $ENV{'BIOPERLDEBUG'} || $self->verbose  > 0 ) {
      carp("Use of Bundle::Bio::Root::RootI is deprecated.  Please use Bundle::Bio::Root::Root instead");
  }
  return;
}
...
=head2 throw_not_implemented
 ...
 Purpose : Throws a Bundle::Bio::Root::NotImplemented exception.
 ...
 Returns : n/a
 Args    : n/a
 Throws  : A Bundle::Bio::Root::NotImplemented exception.
...
sub throw_not_implemented {
    ...
    # Bundle::Bio::Root::Root::throw() knows how to check for Error.pm and will
    # throw an Error-derived object of the specified class (Bundle::Bio::Root::NotImplemented),
    # which is defined in Bundle::Bio::Root::Exception.
